...
public class MainActivity extends BaseActivity implements IXListViewListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
        case R.id.addButton:
            Toast.makeText(MainActivity.this, "Thanks for your interview,dear.", 1).show();
            break;
    ...
    private void initView() {
        ...
        // title animation set
        ObjectAnimator animateAlpha = ObjectAnimator.ofFloat(homeButton, "alpha", 0f, 1f);
        ObjectAnimator animateScaleX = ObjectAnimator.ofFloat(homeButton, "scaleX", 0f, 1f);
        ObjectAnimator animateScaleY = ObjectAnimator.ofFloat(homeButton, "scaleY", 0f, 1f);
